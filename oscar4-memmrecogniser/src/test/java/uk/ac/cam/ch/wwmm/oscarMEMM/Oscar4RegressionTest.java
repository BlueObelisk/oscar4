...
public class Oscar4RegressionTest {
	...
	public void testSentence1RemoveBlocked() throws Exception {
		...
		List<String> expectedTypeList = Arrays.asList("CM", "CM",
				"CM", "ONT", "RN", "CM", "CM", "CM");
		evaluateNamedEntities(sentence, true, expectedSurfaceList, expectedTypeList,
				expectedProbList);
	}
	...
	public void testSentence1MarkBlocked() throws Exception {
		...
		evaluateNamedEntities(sentence, false, expectedSurfaceList, expectedTypeList,
				expectedProbList);
	}
	 ...
	 */
    private void evaluateNamedEntities(String sentence, boolean removeBlocked,
		...
		List<NamedEntity> neList = recogniser.findNamedEntities(
				procDoc.getTokenSequences(), removeBlocked);
